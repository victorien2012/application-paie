...
@section('content')
  ...
  <circle cx="8" cy="4.5" r="1"/>
                            ...
                            <input type="text" class="form-control" id="setting-input-2" placeholder="Entrer le Nom" name="first_name" value="{{old('first_name')}}"
                                   required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3"  placeholder="Entrer le Prénom" name="last_name" value="{{old('last_name')}}" required>
                        </div>
                        @error('last_name')
                        <div class="text-danger">{{$message}}</div>
                        @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-4" name="contact" placeholder="Enter le Contact" value="{{old('contact')}}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="setting-input-5" name="email" placeholder="Entrer le Email" value="{{old('contact')}}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="sexe" class="form-control" id="setting-input-5" name="sexe" placeholder="Préciser le sexe" value="{{old('sexe')}}" required>
                        </div>
