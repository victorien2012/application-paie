...
@section('content')
  ...
  <circle cx="8" cy="4.5" r="1"/>
                ...
                <div class="mb-3">
                    ...
                    <input type="" class="form-control" id="setting-input-5" name="montant_journalier" placeholder="Entrer le Montant journalier" value="{{$employer->montant_journalier}}" required>
                </div>
