...
@section('content')
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            ...
            <div class="section-intro">Modifier  Ici un nouvel Departement</div>
        </div>
        <div class="col-12 col-md-4">
  ...
  <circle cx="8" cy="4.5" r="1"/>
                            ...
                            <input type="text" class="form-control" id="setting-input-1" placeholder="Entrer le Nom" name="name" value="{{$departement->name}}" required>
                        </div>
